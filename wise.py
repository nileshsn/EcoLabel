...
product_names = [
    "Almonds", "Apples", "Bananas", "Broccoli", "Butter",
    "Carrots", "Cheese", "Chickpeas", "Coffee", "Coke",
    "Cornflakes", "Garlic", "Grapes", "Mangoes", "Milk",
    "Onion", "Oranges", "Pineapple", "Popcorn", "Potatoes",
    "Rice", "Soda", "Spinach", "Tea", "Tomatoes",
    "Yogurt", "Blueberries", "Eggs", "Bread", "Chocolate",
    "Cookies", "Chicken", "Pasta", "Pizza", "Fish",
    "Juice", "Peanuts", "Honey", "Sugar", "Salt",
    "Pepper", "Ketchup", "Cereal", "Bacon", "Water",
    "Shampoo", "Soap", "Toothbrush", "Toothpaste", "Towel",
    "Deodorant", "Lotion", "Sunscreen", "Conditioner", "Tissues",
    "Notebook", "Pen", "Pencil", "Eraser", "Marker",
    "Scissors", "Glue", "Tape", "Ruler", "Bag",
    "Bottle", "Socks", "Shoes", "Glasses", "Mask",
    "Batteries", "Lightbulb", "Chair", "Table", "Blanket",
    "Pillow", "Mug", "Plate", "Fork", "Spoon",
    "Knife", "Laptop", "Phone", "Charger", "Headphones",
    "Broom", "Detergent", "Soap", "Sponge", "Towel",
    "Comb", "Brush", "Mirror", "Bucket", "Mop",
    "Belt", "Wallet", "Hat", "Scarf", "Gloves",
    "Cap", "Watch", "Umbrella", "Lamp", "Fan",
    "Razor", "Nail", "Clipper", "Bandage", "Sunscreen",
    "Perfume", "Ring", "Necklace", "Bracelet", "Earrings",
    "Clock", "Calendar", "Painting", "Vase", "Plant",
    "Basket", "Curtains", "Blender", "Mixer", "Toaster",
    "Oven", "Stove", "Fridge", "Freezer", "Microwave",
    "Drill", "Hammer", "Screwdriver", "Wrench", "Tape",
    "Bag", "Backpack", "Suitcase", "Basketball", "Football",
    "Bike", "Helmet", "Guitar", "Violin", "Camera",
    "Tripod", "Binoculars", "Tent", "SleepingBag", "Flashlight",
    "Pancakes", "Burger", "Hotdog", "Lemon", "Lime",
    "Peaches", "Pears", "Plums", "Avocado", "Coconut",
    "Papaya", "Dates", "Turkey", "Salmon",
    "Tuna", "Shrimp", "Oysters", "Cabbage", "Celery",
    "Peas", "Zucchini", "Eggplant", "Radish", "Beet",
    "Mushrooms", "Asparagus", "Quinoa", "Noodles", "Bagels",
    "Muffin", "Doughnut", "Brownies", "Cupcake", "Chips",
    "Pickles", "Olives", "Jam", "Mustard", "Mayonnaise"
]
